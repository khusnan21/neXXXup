...
@RequiresOptIn(
    message = "This API is only available on prerelease builds. " +
              "Using it will cause Nexxxup stable to crash.",
    ...
    companion object {
        ...
        fun fromOld(value: Int?): Score? {
            ...
            if (value < 0 || value > 10000) {
                com.unan.api.Log.w(TAG, "old: $value ∉ [0, 10000]")
                return null
            }
        ...
        fun from(value: Int?, maxScore: Int): Score? {
            ...
            if (value < 0 || value > maxScore) {
                com.unan.api.Log.w(TAG, "fromInt: $value ∉ [0, $maxScore]")
                return null
            }
        ...
        fun from(value: Double?, maxScore: Int): Score? {
            ...
            if (value < 0.0 || value > maxScore) {
                com.unan.api.Log.w(TAG, "fromDouble: $value ∉ [0.0, $maxScore]")
                return null
            }
        ...
        fun from(value: Float?, maxScore: Int): Score? {
            ...
            if (value < 0.0 || value > maxScore) {
                com.unan.api.Log.w(TAG, "fromFloat: $value ∉ [0.0f, $maxScore]")
                return null
            }
