...
@Deprecated(
    ...
    replaceWith = ReplaceWith("amap(f)", "com.unan.nexxxup.amap"),
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("amapIndexed(f)", "com.unan.nexxxup.amapIndexed"),
    level = DeprecationLevel.ERROR
)
@Throws(CancellationException::class)
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("runAllAsync(transforms)", "com.unan.nexxxup.runAllAsync"),
    level = DeprecationLevel.ERROR
)
@Throws(CancellationException::class)
fun <R> argamap(
