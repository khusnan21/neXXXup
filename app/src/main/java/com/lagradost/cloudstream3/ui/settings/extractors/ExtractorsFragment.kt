...
import com.lagradost.cloudstream3.databinding.FragmentExtractorsBinding
import com.lagradost.cloudstream3.mvvm.safeApiCall
import com.lagradost.cloudstream3.plugins.JsExtractorRepoData
import com.lagradost.cloudstream3.plugins.JsExtractorRepositoryManager
...
class ExtractorsFragment : Fragment() {
                ...
                uris.amap { uri ->
                    try {
                        context.contentResolver.openInputStream(uri)?.use { inputStream ->
                            ...
                            com.lagradost.cloudstream3.plugins.JsExtractorLoader.loadCode(content, fileName)
    ...
    private fun loadData() {
        ...
        if (extractorsAdapter == null) {
            extractorsAdapter = ExtractorsAdapter(extractors) { file ->
                ...
                com.lagradost.cloudstream3.utils.extractorApis.removeAll {
                    it is com.lagradost.cloudstream3.plugins.JsExtractor && 
    ...
    private fun downloadAndInstallExtractor(name: String, url: String) {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            try {
                val code = com.lagradost.cloudstream3.app.get(url).text
                ...
                com.lagradost.cloudstream3.plugins.JsExtractorLoader.loadCode(code, fileName)
