...
class PluginAdapter(
    ...
    override fun onBindContent(holder: ViewHolderState<Any>, item: PluginViewData, position: Int) {
        ...
        val hasUpdate = item.isDownloaded && localPlugin != null && metadata.version > localPlugin.version && metadata.version != com.lagradost.cloudstream3.plugins.PLUGIN_VERSION_NOT_SET
