...
import com.lagradost.cloudstream3.ui.home.ResumeItemAdapter
    ...
    override fun onBindingCreated(
        ...
        val historyAdapter = ResumeItemAdapter(
            clickCallback = { callback ->
                if (callback.action == com.lagradost.cloudstream3.ui.search.SEARCH_ACTION_SHOW_METADATA) {
                    val context = binding.root.context ?: return@ResumeItemAdapter
                    if (callback.card is DataStoreHelper.ResumeWatchingResult) {
                        activity?.let { act ->
                            com.lagradost.cloudstream3.utils.SingleSelectionHelper.apply {
