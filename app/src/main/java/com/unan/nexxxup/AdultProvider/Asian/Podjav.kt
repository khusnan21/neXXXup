    ...
    override suspend fun loadLinks(
        ...
        if (videoElement != null) {
            ...
            if (dataSourcesRaw.isNotBlank() && dataSourcesRaw != "[]") {
                val sources = AppUtils.parseJson<List<PodjavVideoSource>>(dataSourcesRaw)
            ...
            if (dataSubtitlesRaw.isNotBlank() && dataSubtitlesRaw != "[]") {
                val subtitles = AppUtils.parseJson<List<PodjavSubtitleSource>>(dataSubtitlesRaw)
        ...
        if (embedUrl != null) {
            ...
            try {
                ...
                if (videoLink != null) {
                    ...
                    // Jika regex gagal, serahkan ke Extractor bawaan Nexxxup
 ...
 */
data class PodjavVideoSource(
    @JsonProperty("url") val url: String,
    @JsonProperty("type") val type: String?,
    @JsonProperty("label") val label: String?
)

data class PodjavSubtitleSource(
