...
class TurkPorno : MainAPI() {
    override var mainUrl = "https://turkporno.com"
    ...
    override val mainPage = mainPageOf(
        ...
        "$mainUrl/turbanli-porno/" to "Türbanlı Porno",
        "$mainUrl/ensest-porno/" to "Ensest Porno",
        "$mainUrl/amatör-porno/" to "Amatör Porno",
        "$mainUrl/populer-porno/" to "Popüler Porno"
    )
