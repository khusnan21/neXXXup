...
import com.unan.nexxxup.AdultProvider.Asian.DGSUtils.absoluteUrl
import com.unan.nexxxup.AdultProvider.Asian.DGSUtils.titleFromSlug
import com.unan.nexxxup.AdultProvider.Asian.DGSUtils.cleanTitle
import com.unan.nexxxup.AdultProvider.Asian.DGSUtils.isVideoUrl
import com.unan.nexxxup.AdultProvider.Asian.DGSUtils.isUsablePosterUrl
import com.unan.nexxxup.AdultProvider.Asian.DGSUtils.cleanText
import com.unan.nexxxup.SearchResponse
import com.unan.nexxxup.TvType
import com.unan.nexxxup.addEpisodes
import com.unan.nexxxup.newAnimeLoadResponse
...
object DGSParser {
    ...
    suspend fun parseLoadResponse(api: MainAPI, url: String, document: Document): LoadResponse? {
        ...
        return api.newAnimeLoadResponse(title, url, TvType.NSFW) {
            ...
            addEpisodes(com.unan.nexxxup.DubStatus.Subbed, listOf<Episode>(playable))
        }
    }
}
