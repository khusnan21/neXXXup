...
class YTBoob : MainAPI() {
    ...
    override suspend fun search(query: String, page: Int): SearchResponseList {
        ...
        val response: YTBoobResult = mapper.readValue(document)
    ...
    private fun YTBoobIcerik.toSearchResult(): SearchResponse? {
...
data class YTBoobResult(
    val results: List<YTBoobCevap>?
)

@JsonIgnoreProperties(ignoreUnknown = true)
data class YTBoobCevap(
    val hits: List<YTBoobGelen>?
)
@JsonIgnoreProperties(ignoreUnknown = true)
data class YTBoobGelen(
    val document: YTBoobIcerik?
)
@JsonIgnoreProperties(ignoreUnknown = true)
data class YTBoobIcerik(
