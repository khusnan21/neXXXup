...
import com.unan.nexxxup.APIHolder.removePluginMapping
import com.unan.nexxxup.AllLanguagesName
import com.unan.nexxxup.AutoDownloadMode
...
import com.unan.nexxxup.MainAPI.Companion.settingsForProvider
import com.unan.nexxxup.MainActivity.Companion.afterPluginsLoadedEvent
import com.unan.nexxxup.MainActivity.Companion.lastError
import com.unan.nexxxup.PROVIDER_STATUS_DOWN
import com.unan.nexxxup.PROVIDER_STATUS_OK
...
import com.unan.nexxxup.mvvm.debugPrint
import com.unan.nexxxup.mvvm.logError
import com.unan.nexxxup.mvvm.safe
import com.unan.nexxxup.plugins.RepositoryManager.ONLINE_PLUGINS_FOLDER
import com.unan.nexxxup.plugins.RepositoryManager.PREBUILT_REPOSITORIES
import com.unan.nexxxup.plugins.RepositoryManager.downloadPluginToFile
import com.unan.nexxxup.plugins.RepositoryManager.getRepoPlugins
import com.unan.nexxxup.ui.settings.extensions.REPOSITORIES_KEY
...
const val EXTENSIONS_CHANNEL_ID = "nexxxup.extensions"
...
object PluginManager {
    ...
    private val CLOUD_STREAM_FOLDER =
        Environment.getExternalStorageDirectory().absolutePath + "/Nexxxup/"
    ...
    suspend fun ___DO_NOT_CALL_FROM_A_PLUGIN_downloadNotExistingPluginsAndLoad(
        ...
        val notDownloadedPlugins = onlinePlugins.mapNotNull { onlineData ->
            ...
            if (mode == AutoDownloadMode.FilterByLang) {
                ...
                // Completely allow any language for extension plugins
