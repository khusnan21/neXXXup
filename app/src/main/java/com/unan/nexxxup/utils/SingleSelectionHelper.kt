...
import com.unan.nexxxup.databinding.BottomInputDialogBinding
import com.unan.nexxxup.databinding.BottomSelectionDialogBinding
import com.unan.nexxxup.databinding.BottomTextDialogBinding
import com.unan.nexxxup.databinding.OptionsPopupTvBinding
...
object SingleSelectionHelper {
    ...
    private fun BottomSheetDialog.centerBottomSheet() {
        setOnShowListener { dialogInterface ->
            val d = dialogInterface as BottomSheetDialog
            val bottomSheet = d.findViewById<android.view.View>(com.google.android.material.R.id.design_bottom_sheet) as? android.widget.FrameLayout
            if (bottomSheet != null) {
                ...
                if (layoutParams != null) {
                    ...
                    val displayMetrics = bottomSheet.context.resources.displayMetrics
                    val width = (displayMetrics.widthPixels * 0.85).toInt()
                    layoutParams.width = if (width < 1000) width else 1000
