...
import com.unan.nexxxup.NexxxupApp.Companion.getKeys
...
import com.unan.nexxxup.services.DownloadQueueService
...
import com.unan.nexxxup.utils.downloader.VideoDownloadManager.downloadStatus
import com.unan.nexxxup.utils.downloader.VideoDownloadManager.downloadStatusEvent
import com.unan.nexxxup.utils.downloader.VideoDownloadManager.getDownloadFileInfo
import com.unan.nexxxup.utils.downloader.VideoDownloadManager.getDownloadQueuePackage
import com.unan.nexxxup.utils.downloader.VideoDownloadManager.getDownloadResumePackage
...
object DownloadQueueManager {
     ...
     * @see com.unan.nexxxup.services.DownloadQueueService.Companion.downloadInstances
     */
    ...
    fun addToQueue(downloadQueueWrapper: DownloadQueueWrapper) = safe {
        val context = NexxxupApp.context ?: return@safe
