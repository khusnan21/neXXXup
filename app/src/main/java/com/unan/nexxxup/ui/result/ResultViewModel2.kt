...
import com.unan.nexxxup.actions.AlwaysAskAction
...
import com.unan.nexxxup.APIHolder.unixTime
import com.unan.nexxxup.APIHolder.unixTimeMS
...
import com.unan.nexxxup.CommonActivity.getCastSession
import com.unan.nexxxup.CommonActivity.showToast
import com.unan.nexxxup.LoadResponse.Companion.addTrailer
import com.unan.nexxxup.LoadResponse.Companion.getMalId
import com.unan.nexxxup.LoadResponse.Companion.isMovie
import com.unan.nexxxup.LoadResponse.Companion.readIdFromString
import com.unan.nexxxup.metaproviders.SyncRedirector
...
import com.unan.nexxxup.sortUrls
import com.unan.nexxxup.syncproviders.AccountManager
import com.unan.nexxxup.syncproviders.AccountManager.Companion.secondsToReadable
...
import com.unan.nexxxup.ui.player.IGenerator
import com.unan.nexxxup.ui.player.LOADTYPE_ALL
import com.unan.nexxxup.ui.player.LOADTYPE_CHROMECAST
import com.unan.nexxxup.ui.player.LOADTYPE_INAPP
import com.unan.nexxxup.ui.player.LOADTYPE_INAPP_DOWNLOAD
import com.unan.nexxxup.ui.player.RepoLinkGenerator
import com.unan.nexxxup.ui.player.SubtitleData
import com.unan.nexxxup.ui.result.EpisodeAdapter.Companion.getPlayerAction
import com.unan.nexxxup.utils.AppContextUtils.getNameFull
import com.unan.nexxxup.utils.AppContextUtils.isConnectedToChromecast
import com.unan.nexxxup.utils.AppContextUtils.setDefaultFocus
import com.unan.nexxxup.utils.AppContextUtils.sortSubs
import com.unan.nexxxup.utils.CastHelper.startCast
import com.unan.nexxxup.utils.Coroutines.ioSafe
import com.unan.nexxxup.utils.Coroutines.ioWork
import com.unan.nexxxup.utils.Coroutines.ioWorkSafe
import com.unan.nexxxup.utils.Coroutines.main
import com.unan.nexxxup.utils.DOWNLOAD_HEADER_CACHE
import com.unan.nexxxup.utils.DataStore
import com.unan.nexxxup.utils.DataStore.editor
import com.unan.nexxxup.utils.DataStore.getFolderName
...
import com.unan.nexxxup.utils.DataStoreHelper.deleteBookmarkedData
import com.unan.nexxxup.utils.DataStoreHelper.getAllBookmarkedData
...
import com.unan.nexxxup.utils.DataStoreHelper.getDub
import com.unan.nexxxup.utils.DataStoreHelper.getFavoritesData
import com.unan.nexxxup.utils.DataStoreHelper.getLastWatched
import com.unan.nexxxup.utils.DataStoreHelper.getResultEpisode
import com.unan.nexxxup.utils.DataStoreHelper.getResultSeason
import com.unan.nexxxup.utils.DataStoreHelper.getResultWatchState
import com.unan.nexxxup.utils.DataStoreHelper.getSubscribedData
import com.unan.nexxxup.utils.DataStoreHelper.getVideoWatchState
import com.unan.nexxxup.utils.DataStoreHelper.getViewPos
import com.unan.nexxxup.utils.DataStoreHelper.removeFavoritesData
import com.unan.nexxxup.utils.DataStoreHelper.removeSubscribedData
import com.unan.nexxxup.utils.DataStoreHelper.setBookmarkedData
import com.unan.nexxxup.utils.DataStoreHelper.setDub
import com.unan.nexxxup.utils.DataStoreHelper.setFavoritesData
import com.unan.nexxxup.utils.DataStoreHelper.setResultEpisode
import com.unan.nexxxup.utils.DataStoreHelper.setResultSeason
import com.unan.nexxxup.utils.DataStoreHelper.setResultWatchState
import com.unan.nexxxup.utils.DataStoreHelper.setSubscribedData
import com.unan.nexxxup.utils.DataStoreHelper.setVideoWatchState
import com.unan.nexxxup.utils.DataStoreHelper.updateSubscribedData
import com.unan.nexxxup.utils.Editor
import com.unan.nexxxup.utils.ExtractorLink
import com.unan.nexxxup.utils.ExtractorLinkType
import com.unan.nexxxup.utils.FillerEpisodeCheck
...
import com.unan.nexxxup.utils.VIDEO_WATCH_STATE
import com.unan.nexxxup.utils.downloader.DownloadFileManagement.sanitizeFilename
import com.unan.nexxxup.utils.downloader.VideoDownloadManager.getDownloadEpisodeMetadata
import com.unan.nexxxup.utils.downloader.DownloadObjects
import com.unan.nexxxup.utils.downloader.DownloadUtils.downloadSubtitle
...
class ResultViewModel2 : ViewModel() {
    ...
    private fun checkAndWarnDuplicates(
        ...
        val malId = syncData?.get("mal")
        val aniListId = syncData?.get("anilist")
        ...
        val duplicateEntries = data.filter { it: DataStoreHelper.LibrarySearchResponse ->
            ...
            val checks = listOf(
                ...
                { malId != null && librarySyncData?.get("mal") == malId },
                { aniListId != null && librarySyncData?.get("anilist") == aniListId },
    ...
    private fun acquireSingleLink(
        ...
        loadLinks(result, isVisible = true, sourceTypes, isCasting = isCasting) { links ->
            ...
            //val context = NexxxupApp.context
            postPopup(
                text,
