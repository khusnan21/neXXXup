...
import com.unan.nexxxup.LoadResponse.Companion.getAniListId
import com.unan.nexxxup.LoadResponse.Companion.getImdbId
import com.unan.nexxxup.LoadResponse.Companion.getMalId
import com.unan.nexxxup.LoadResponse.Companion.getTMDbId
import com.unan.nexxxup.MainActivity
import com.unan.nexxxup.R
import com.unan.nexxxup.TvType
import com.unan.nexxxup.amap
import com.unan.nexxxup.databinding.DialogOnlineSubtitlesBinding
import com.unan.nexxxup.databinding.FragmentPlayerBinding
import com.unan.nexxxup.databinding.PlayerSelectSourceAndSubsBinding
import com.unan.nexxxup.databinding.PlayerSelectTracksBinding
import com.unan.nexxxup.isAnimeOp
import com.unan.nexxxup.isEpisodeBased
import com.unan.nexxxup.isLiveStream
import com.unan.nexxxup.isMovieType
...
import com.unan.nexxxup.subtitles.AbstractSubtitleEntities
import com.unan.nexxxup.subtitles.AbstractSubtitleEntities.SubtitleSearch
import com.unan.nexxxup.syncproviders.AccountManager.Companion.subtitleProviders
import com.unan.nexxxup.ui.download.DownloadButtonSetup
import com.unan.nexxxup.ui.player.CS3IPlayer.Companion.preferredAudioTrackLanguage
import com.unan.nexxxup.ui.player.CustomDecoder.Companion.updateForcedEncoding
import com.unan.nexxxup.ui.player.PlayerSubtitleHelper.Companion.toSubtitleMimeType
import com.unan.nexxxup.ui.player.source_priority.LinkSource
...
import com.unan.nexxxup.ui.result.ACTION_CLICK_DEFAULT
import com.unan.nexxxup.ui.result.EpisodeAdapter
import com.unan.nexxxup.ui.result.FOCUS_SELF
import com.unan.nexxxup.ui.result.ResultEpisode
import com.unan.nexxxup.ui.result.ResultFragment
...
import com.unan.nexxxup.ui.subtitles.SUBTITLE_AUTO_SELECT_KEY
import com.unan.nexxxup.ui.subtitles.SubtitlesFragment
import com.unan.nexxxup.ui.subtitles.SubtitlesFragment.Companion.getAutoSelectLanguageTagIETF
...
import com.unan.nexxxup.utils.SubtitleHelper.fromTagToLanguageName
import com.unan.nexxxup.utils.SubtitleHelper.languages
...
import com.unan.nexxxup.utils.UIHelper.hideSystemUI
import com.unan.nexxxup.utils.UIHelper.popCurrentPage
    ...
    private val subsPathPicker =
        registerForActivityResult(ActivityResultContracts.OpenDocument()) { uri ->
            safe {
                ...
                val ctx = context ?: NexxxupApp.context ?: return@safe
