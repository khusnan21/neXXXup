...
import com.unan.nexxxup.databinding.FragmentDiscoverBinding
...
class DiscoverFragment : BaseFragment<FragmentDiscoverBinding>(
    ...
    class ProviderAdapter(
        private var providers: List<com.unan.nexxxup.MainAPI>,
        private val clickCallback: (com.unan.nexxxup.MainAPI) -> Unit
        ...
        inner class ProviderViewHolder(val view: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(view) {
            ...
            fun bind(api: com.unan.nexxxup.MainAPI) {
                nameText.text = api.name
                urlText.text = api.mainUrl.substringAfter("://")
                langBadge.text = api.lang

                if (api.supportedTypes.contains(com.unan.nexxxup.TvType.NSFW)) {
        ...
        fun updateData(newProviders: List<com.unan.nexxxup.MainAPI>) {
    ...
    private fun getProviderCategory(api: com.unan.nexxxup.MainAPI): String {
    ...
    fun filterProviders() {
        ...
        val allApis = com.unan.nexxxup.APIHolder.apis.toMutableList()
    ...
    override fun onBindingCreated(
        ...
        reloadRepos()
        binding.apply {
            val apis = com.unan.nexxxup.APIHolder.apis.toMutableList().sortedBy { it.name.lowercase() }
