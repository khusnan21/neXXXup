...
import com.unan.nexxxup.databinding.FragmentSetupProviderLanguagesBinding
        ...
        safe {
            ...
            binding.apply {
                ...
                nextBtt.setOnClickListener {
                    ...
                    settingsManager.edit {
                        putStringSet(getString(R.string.prefer_media_type_key), allTypes)
                    }
                    setKey(HAS_DONE_SETUP_KEY, true)
                    findNavController().navigate(R.id.navigation_home)
                }

                prevBtt.isVisible = false
            }
        }
    }
}
