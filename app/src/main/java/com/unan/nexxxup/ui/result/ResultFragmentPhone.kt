...
import com.unan.nexxxup.databinding.FragmentResultBinding
import com.unan.nexxxup.databinding.FragmentResultSwipeBinding
import com.unan.nexxxup.databinding.ResultRecommendationsBinding
import com.unan.nexxxup.databinding.ResultSyncBinding
...
import com.unan.nexxxup.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.unan.nexxxup.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.unan.nexxxup.ui.download.DownloadButtonSetup
import com.unan.nexxxup.ui.player.CSPlayerEvent
import com.unan.nexxxup.ui.player.FullScreenPlayer
...
import com.unan.nexxxup.ui.result.ResultFragment.getStoredData
import com.unan.nexxxup.ui.result.ResultFragment.updateUIEvent
...
import com.unan.nexxxup.utils.AppContextUtils.openBrowser
...
import com.unan.nexxxup.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.unan.nexxxup.utils.SingleSelectionHelper.showBottomDialogInstant
...
import com.unan.nexxxup.utils.UIHelper.populateChips
import com.unan.nexxxup.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.unan.nexxxup.utils.UIHelper.setListViewHeightBasedOnItems
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.unan.nexxxup.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.unan.nexxxup.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.unan.nexxxup.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
